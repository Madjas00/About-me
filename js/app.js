...
var question1 = prompt(questionText).toLowerCase();
  ...
  console.log("User's response is " + answer + "to question" + questionNuber + ".");
}


var questionText = "Okay " + name + ", am I over the age of 25?";
var correctWord = "yes";
var correctMessage = "I am 28";
var incorrectMessage = "Incorrect. I'm actually 28, ";

askQuestion1(questionText, correctWord, correctMessage, incorrectMessage);
askQuestion1("Am I older than 25?", "yes", "Correct", "I'm 28 years old.");
